...
#Sampler
TEV = 0.0001
spl = MCHMC(1, TEV; adaptive=true, init_eps=30, init_L=500, sigma=precond);
fol_name=string("/mnt/extraspace/jaimerz/mchmc_chains/MCHMC/CMBLensing",
...
samples_mchmc = Sample(spl, target, 1, dialog=false, progress=true,
